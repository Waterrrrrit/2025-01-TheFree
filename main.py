...
st.markdown("""
            ...
            """, unsafe_allow_html=True)
data = pd.DataFrame({
    "날짜": ["2025-01-15", "2025-01-16", "2025-01-17", "2025-01-18","2025-01-19","2025-01-20","2025-01-21","2025-01-22","2025-01-23","2025-01-24","2025-01-25","2025-01-26"],
    "증감율": [-0.01137, -0.009474, -0.007757, -0.005907, -0.005152, -0.003757, -0.00234, -0.001141, 0, 0.0253, -0.008, 0.006]
})
fig1 = px.line(data, x="날짜", y="증감율")
fig1.update_traces(line=dict(color="#fdc01f"))
fig1.update_layout(
    yaxis=dict(range=[-0.1000, 0.1000])
)
...
data2 = pd.DataFrame({
    "날짜": ["2025-01-15", "2025-01-16", "2025-01-17", "2025-01-18", "2025-01-19", "2025-01-20", "2025-01-21", "2025-01-22", "2025-01-23", "2025-01-24", "2025-01-25", "2025-01-26"],
    "휘발유가": [1731, 1733, 1736, 1740, 1741, 1743, 1730, 1733, 1732, 1728, 1727, 1728]
})
# 라인 그래프 생성
fig2 = px.line(data2, x="날짜", y="휘발유가", title="")
fig2.update_traces(line=dict(color="#fdc01f"))
